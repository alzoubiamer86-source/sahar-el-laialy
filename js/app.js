...
(function(){
  ...
  if(saved && saved!=='night') document.documentElement.dataset.theme=saved;
})();
function setTheme(name){
  if(name==='night') delete document.documentElement.dataset.theme;
...
const RANK_PERMS_MAX = {
  ...
  super_admin: ['blockMachine','muteUsers','kickout','banUsers','sortMicList','clearText','broadcast','unban','viewLog','manageAccounts','manageMembers','manageAdmins','sendImages','dragToRoom','roomSettings','adminReports','profilePic'],
  master:      ['blockMachine','muteUsers','kickout','banUsers','sortMicList','clearText','broadcast','unban','viewLog','manageAccounts','manageMembers','manageAdmins','manageSuperAdmins','sendImages','dragToRoom','roomSettings','adminReports','profilePic','machineLock'],
};
