...
const Voice = (() => {
  ...
  function _playAudio(socketId, stream) {
    ...
    audio.dataset.voiceSocketId = socketId; // tag for cleanup
...
// ── Instant disconnect on page hide/unload (fix: no delay on refresh/close) ──
...
// pagehide covers mobile browsers (iOS Safari)
